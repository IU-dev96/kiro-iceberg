...
- [x] 3. Create Obstacle class
  ...
  - Implement checkCollision() method that returns collision side
  - _Requirements: 3.1, 3.2, 8.1_

- [ ]* 3.1 Write property test for obstacle collision prevention
...
- [x] 9. Extend CollisionDetector for obstacle collisions
  - Add checkObstacleCollision() method for side collisions
  - Add checkObstacleTopCollision() method for landing on obstacles
  - Add resolveObstacleCollision() method to prevent passing through
  - Update existing collision methods to work with new physics
  - _Requirements: 3.2, 8.1, 8.2, 8.3, 8.5, 11.5_

- [ ]* 9.1 Write property test for successful jump passage
...
- [x] 11. Update GameEngine to integrate jumping and obstacles
  ...
  - Update checkCollisions() to check obstacle collisions
  - Update checkCollisions() to check door interaction
  - Update transitionToLevel() to handle 6 levels
  - _Requirements: 2.1, 2.3, 3.2, 4.3, 5.2, 5.4, 7.5, 11.3_
